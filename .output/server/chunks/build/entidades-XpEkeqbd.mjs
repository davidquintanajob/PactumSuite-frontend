...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-gradient-to-br via-secondary/40 from-accent/30 to-neutral" }, _attrs))} data-v-b48338b8>`);
      ...
      if (errorBanner.value) {
        _push(`<div class="fixed top-6 left-1/2 transform -translate-x-1/2 z-[9999] w-full max-w-md px-4 pointer-events-none" data-v-b48338b8>`);
        _push(ssrRenderComponent(_sfc_main$2, {
      ...
      if (showConfirmBanner.value) {
        _push(`<div class="fixed top-24 left-1/2 transform -translate-x-1/2 z-[10000] w-full max-w-md px-4 pointer-events-auto" data-v-b48338b8>`);
      ...
      _push(`<div class="w-[95%] mx-auto px-4 py-4 md:py-4 mt-20 md:mt-0" data-v-b48338b8><div class="bg-white rounded-lg shadow-md p-4" data-v-b48338b8><div class="mb-4" data-v-b48338b8><label class="block text-sm font-medium text-gray-700 mb-1" data-v-b48338b8>Buscar por nombre</label><div class="relative" data-v-b48338b8><input type="text"${ssrRenderAttr("value", nombre.value)} placeholder="Ingrese el nombre..." class="w-full pl-10 pr-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary" data-v-b48338b8><div class="absolute left-3 top-2.5" data-v-b48338b8><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-b48338b8><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" data-v-b48338b8></path></svg></div></div></div><div class="md:hidden flex justify-between items-center mb-4" data-v-b48338b8><button class="flex items-center text-primary hover:brightness-90" data-v-b48338b8><span class="mr-2" data-v-b48338b8>Filtros adicionales</span><svg xmlns="http://www.w3.org/2000/svg" class="${ssrRenderClass([{ "rotate-180": showFilters.value }, "h-5 w-5 transform transition-transform"])}" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-b48338b8><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-b48338b8></path></svg></button></div><div class="${ssrRenderClass([{ "hidden md:grid": !showFilters.value }, "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4"])}" data-v-b48338b8><div class="w-full" data-v-b48338b8><label class="block text-sm font-medium text-gray-700 mb-1" data-v-b48338b8>Buscar por direcci\xF3n</label><div class="relative" data-v-b48338b8><input type="text"${ssrRenderAttr("value", direccion.value)} placeholder="Ingrese la direcci\xF3n..." class="w-full pl-10 pr-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary" data-v-b48338b8><div class="absolute left-3 top-2.5" data-v-b48338b8><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-b48338b8><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" data-v-b48338b8></path></svg></div></div></div><div class="w-full" data-v-b48338b8><label class="block text-sm font-medium text-gray-700 mb-1" data-v-b48338b8>Tel\xE9fono</label><input type="text"${ssrRenderAttr("value", telefono.value)} placeholder="Ingrese tel\xE9fono" class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary" data-v-b48338b8></div><div class="w-full" data-v-b48338b8><label class="block text-sm font-medium text-gray-700 mb-1" data-v-b48338b8>Cuenta bancaria</label><input type="text"${ssrRenderAttr("value", cuenta_bancaria.value)} placeholder="Ingrese cuenta bancaria" class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500" data-v-b48338b8></div><div class="w-full" data-v-b48338b8><label class="block text-sm font-medium text-gray-700 mb-1" data-v-b48338b8>Tipo de entidad</label><input type="text"${ssrRenderAttr("value", tipo_entidad.value)} placeholder="Ingrese tipo de entidad" class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500" data-v-b48338b8></div><div class="w-full" data-v-b48338b8><label class="block text-sm font-medium text-gray-700 mb-1" data-v-b48338b8>C\xF3digo REEUP</label><input type="text"${ssrRenderAttr("value", codigo_reo.value)} placeholder="Ingrese c\xF3digo REEUP" class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500" data-v-b48338b8></div><div class="w-full" data-v-b48338b8><label class="block text-sm font-medium text-gray-700 mb-1" data-v-b48338b8>Organismo</label><input type="text"${ssrRenderAttr("value", organismo.value)} placeholder="Ingrese organismo" class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary" data-v-b48338b8></div><div class="w-full" data-v-b48338b8><label class="block text-sm font-medium text-gray-700 mb-1" data-v-b48338b8>Consecutivo</label><input type="text"${ssrRenderAttr("value", consecutivo.value)} placeholder="Ingrese consecutivo" class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary" data-v-b48338b8></div></div><div class="flex justify-end mt-4 gap-2" data-v-b48338b8><button class="px-6 py-2 bg-primary text-neutral rounded-lg hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 transition-colors" data-v-b48338b8> Buscar </button>`);
      if (!isInvitado.value) {
        _push(`<button class="px-6 py-2 bg-success text-neutral rounded-lg hover:bg-success/90 focus:outline-none focus:ring-2 focus:ring-success focus:ring-offset-2 transition-colors" data-v-b48338b8> Exportar a Excel </button>`);
      } else {
        _push(`<!---->`);
      }
      if (!isInvitado.value) {
        _push(`<button class="px-6 py-2 bg-info text-neutral rounded-lg hover:bg-info/90 focus:outline-none focus:ring-2 focus:ring-info focus:ring-offset-2 transition-colors" data-v-b48338b8> Exportar a Excel con Contratos </button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div></div><div class="w-[95%] mx-auto px-4 py-4" data-v-b48338b8><div class="flex justify-between items-center mb-4" data-v-b48338b8><h2 class="text-2xl font-bold" data-v-b48338b8>Entidades</h2>`);
      if (!isInvitado.value) {
        _push(`<button class="px-4 py-2 bg-primary text-neutral rounded-lg hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary flex items-center" data-v-b48338b8><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-b48338b8><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" data-v-b48338b8></path></svg> Nueva Entidad </button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
      _push(ssrRenderComponent(DataTable, {
        ...
        actions: isInvitado.value ? [] : entidadesActions,
...
const entidades = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b48338b8"]]);

export { entidades as default };
//# sourceMappingURL=entidades-XpEkeqbd.mjs.map
