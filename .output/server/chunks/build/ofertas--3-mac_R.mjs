    ...
    watch(() => [props.oferta, props.id_usuario, props.id_contrato], ([oferta, id_usuario, id_contrato]) => {
      ...
      if (oferta && Object.keys(oferta).length > 0) {
        formData.value = {
          ...
          id_contrato: id_contrato !== null && id_contrato !== void 0 ? (_b = (_a = props.contratos.find((c) => c.id_contrato === id_contrato)) == null ? void 0 : _a.id_contrato) != null ? _b : null : Number(oferta.id_contrato || ((_c = oferta.contrato) == null ? void 0 : _c.id_contrato) || 0) || null,
          id_usuario: id_usuario !== null && id_usuario !== void 0 ? (_e = (_d = props.usuarios.find((u) => u.id_usuario === id_usuario)) == null ? void 0 : _d.id_usuario) != null ? _e : null : Number(oferta.id_usuario || ((_f = oferta.usuario) == null ? void 0 : _f.id_usuario) || 0) || null,
      ...
      ([newUsuarios, newContratos, id_usuario, id_contrato]) => {
        ...
        if (props.oferta && Object.keys(props.oferta).length > 0) {
          if (id_contrato !== null && id_contrato !== void 0) {
            formData.value.id_contrato = (_b = (_a = props.contratos.find((c) => c.id_contrato === id_contrato)) == null ? void 0 : _a.id_contrato) != null ? _b : null;
          } else {
            formData.value.id_contrato = Number(props.oferta.id_contrato || ((_c = props.oferta.contrato) == null ? void 0 : _c.id_contrato) || 0) || null;
          }
          if (id_usuario !== null && id_usuario !== void 0) {
            formData.value.id_usuario = (_e = (_d = props.usuarios.find((u) => u.id_usuario === id_usuario)) == null ? void 0 : _d.id_usuario) != null ? _e : null;
          } else {
            formData.value.id_usuario = Number(props.oferta.id_usuario || ((_f = props.oferta.usuario) == null ? void 0 : _f.id_usuario) || 0) || null;
          }
        }
      }
    );
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$5, {
        ...
        labelKey: (c) => {
          var _a2, _b2, _c2;
          return `${(_a2 = c.entidad) == null ? void 0 : _a2.nombre}: ${c == null ? void 0 : c.num_consecutivo} - ${(_b2 = c.tipoContrato) == null ? void 0 : _b2.nombre} - (${(_c2 = c.fecha_inicio) == null ? void 0 : _c2.substring(0, 4)})`;
        },
        valueKey: "id_contrato",
        placeholder: "Buscar contrato..."
      }, null, _parent));
      ...
      _push(ssrRenderComponent(_sfc_main$2, {
        ...
        id_usuario: (_c = (_b = selectedOferta.value.id_usuario) != null ? _b : (_a = selectedOferta.value.usuario) == null ? void 0 : _a.id_usuario) != null ? _c : null,
        id_contrato: (_f = (_e = selectedOferta.value.id_contrato) != null ? _e : (_d = selectedOferta.value.contrato) == null ? void 0 : _d.id_contrato) != null ? _f : null,
...
//# sourceMappingURL=ofertas--3-mac_R.mjs.map
