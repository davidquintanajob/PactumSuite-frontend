...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-gradient-to-br via-secondary/40 from-accent/30 to-neutral" }, _attrs))} data-v-f82ac173>`);
      ...
      if (errorBanner.value) {
        _push(`<div class="fixed top-6 left-1/2 transform -translate-x-1/2 z-[9999] w-full max-w-md px-4 pointer-events-none" data-v-f82ac173>`);
        _push(ssrRenderComponent(_sfc_main$2, {
      ...
      if (showConfirmBanner.value) {
        _push(`<div class="fixed top-24 left-1/2 transform -translate-x-1/2 z-[10000] w-full max-w-md px-4 pointer-events-auto" data-v-f82ac173>`);
      ...
      _push(`<div class="w-[95%] mx-auto px-4 py-4 md:py-4 mt-20 md:mt-0" data-v-f82ac173><div class="bg-white rounded-lg shadow-md p-4" data-v-f82ac173><div class="mb-4" data-v-f82ac173><label class="block text-sm font-medium text-gray-700 mb-1" data-v-f82ac173>Buscar por nombre</label><div class="relative" data-v-f82ac173><input type="text"${ssrRenderAttr("value", nombre.value)} placeholder="Ingrese el nombre..." class="w-full pl-10 pr-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500" data-v-f82ac173><div class="absolute left-3 top-2.5" data-v-f82ac173><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-f82ac173><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" data-v-f82ac173></path></svg></div></div></div><div class="md:hidden flex justify-between items-center mb-4" data-v-f82ac173><button class="flex items-center text-blue-500 hover:text-blue-600" data-v-f82ac173><span class="mr-2" data-v-f82ac173>Filtros adicionales</span><svg xmlns="http://www.w3.org/2000/svg" class="${ssrRenderClass([{ "rotate-180": showFilters.value }, "h-5 w-5 transform transition-transform"])}" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-f82ac173><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-f82ac173></path></svg></button></div><div class="${ssrRenderClass([{ "hidden md:grid": !showFilters.value }, "grid grid-cols-1 md:grid-cols-3 gap-4 mb-4"])}" data-v-f82ac173><div class="w-full" data-v-f82ac173><label class="block text-sm font-medium text-gray-700 mb-1" data-v-f82ac173>Buscar por nombre de usuario</label><div class="relative" data-v-f82ac173><input type="text"${ssrRenderAttr("value", nombre_usuario.value)} placeholder="Ingrese nombre de usuario..." class="w-full pl-10 pr-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500" data-v-f82ac173><div class="absolute left-3 top-2.5" data-v-f82ac173><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-f82ac173><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" data-v-f82ac173></path></svg></div></div></div><div class="w-full" data-v-f82ac173><label class="block text-sm font-medium text-gray-700 mb-1" data-v-f82ac173>Cargo</label><input type="text"${ssrRenderAttr("value", cargo.value)} placeholder="Ingrese cargo" class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500" data-v-f82ac173></div><div class="w-full" data-v-f82ac173><label class="block text-sm font-medium text-gray-700 mb-1" data-v-f82ac173>Rol</label><select class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500" data-v-f82ac173><option value="" data-v-f82ac173${ssrIncludeBooleanAttr(Array.isArray(rol.value) ? ssrLooseContain(rol.value, "") : ssrLooseEqual(rol.value, "")) ? " selected" : ""}>Todos los roles</option><option value="Administrador" data-v-f82ac173${ssrIncludeBooleanAttr(Array.isArray(rol.value) ? ssrLooseContain(rol.value, "Administrador") : ssrLooseEqual(rol.value, "Administrador")) ? " selected" : ""}>Administrador</option><option value="Comercial" data-v-f82ac173${ssrIncludeBooleanAttr(Array.isArray(rol.value) ? ssrLooseContain(rol.value, "Comercial") : ssrLooseEqual(rol.value, "Comercial")) ? " selected" : ""}>Comercial</option><option value="Invitado" data-v-f82ac173${ssrIncludeBooleanAttr(Array.isArray(rol.value) ? ssrLooseContain(rol.value, "Invitado") : ssrLooseEqual(rol.value, "Invitado")) ? " selected" : ""}>Invitado</option><option value="Vendedor" data-v-f82ac173${ssrIncludeBooleanAttr(Array.isArray(rol.value) ? ssrLooseContain(rol.value, "Vendedor") : ssrLooseEqual(rol.value, "Vendedor")) ? " selected" : ""}>Vendedor</option></select></div><div class="w-full" data-v-f82ac173><label class="block text-sm font-medium text-gray-700 mb-1" data-v-f82ac173>Carnet de Identidad</label><input type="text"${ssrRenderAttr("value", carnet.value)} inputmode="numeric" placeholder="Solo d\xEDgitos (m\xE1x. 11)" class="w-full pl-3 pr-3 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500" maxlength="11" data-v-f82ac173></div></div><div class="flex justify-end mt-4 gap-2" data-v-f82ac173><button class="px-6 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors" data-v-f82ac173> Buscar </button><button class="px-6 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-colors" data-v-f82ac173> Exportar a Excel </button></div></div></div><div class="w-[95%] mx-auto px-4 py-4" data-v-f82ac173><div class="flex justify-between items-center mb-4" data-v-f82ac173><h2 class="text-2xl font-bold" data-v-f82ac173>Usuarios</h2><button class="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 flex items-center" data-v-f82ac173><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-f82ac173><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" data-v-f82ac173></path></svg> Nuevo Usuario </button></div>`);
...
const usuarios = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f82ac173"]]);

export { usuarios as default };
//# sourceMappingURL=usuarios-DA8gThmV.mjs.map
