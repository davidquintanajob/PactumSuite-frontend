...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-BPcMiuM0.mjs')
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-devYr4RE.mjs')
  },
  {
    name: "perfil",
    path: "/perfil",
    component: () => import('./perfil-8RBXZ1sk.mjs')
  },
  {
    name: "ofertas",
    path: "/ofertas",
    component: () => import('./ofertas-Cce8hUn3.mjs')
  },
  {
    name: "facturas",
    path: "/facturas",
    component: () => import('./facturas-DIYhkkb4.mjs')
  },
  {
    name: "usuarios",
    path: "/usuarios",
    component: () => import('./usuarios-DRrsl-Hm.mjs')
  },
  {
    name: "contratos",
    path: "/contratos",
    component: () => import('./contratos-v97Dyk9y.mjs')
  },
  {
    name: "entidades",
    path: "/entidades",
    component: () => import('./entidades-C1DgPWKR.mjs')
  },
  {
    name: "productos",
    path: "/productos",
    component: () => import('./productos-DqpmOofa.mjs')
  },
  {
    name: "servicios",
    path: "/servicios",
    component: () => import('./servicios-D0tqNm-X.mjs')
  },
  {
    name: "trabajadores",
    path: "/trabajadores",
    component: () => import('./trabajadores-DJ8tqKeZ.mjs')
  },
  {
    name: "tipos-contratos",
    path: "/tipos-contratos",
    component: () => import('./tipos-contratos-1hUicOmq.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-D2qgKpaD.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BbZ8X6-p.mjs'));
