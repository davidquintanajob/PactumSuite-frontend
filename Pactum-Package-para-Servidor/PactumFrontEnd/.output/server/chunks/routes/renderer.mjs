...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Platforma para la gestión eficiente de contratos, entidades y trabajadores."},{"name":"theme-color","content":"#93C5FD"},{"name":"keywords","content":"contratos, gestión, trabajadores, entidades, ofertas"},{"property":"og:type","content":"website"},{"property":"og:locale","content":"es_ES"},{"property":"og:site_name","content":"Contract Manager"},{"name":"twitter:card","content":"summary_large_image"}],"link":[{"rel":"icon","type":"image/png","href":"/logo.png"},{"rel":"canonical","href":"http://localhost:4000"}],"style":[],"script":[{"type":"application/ld+json","children":"{\"@context\":\"https://schema.org\",\"@type\":\"Organization\",\"name\":\"Contract Manager\",\"url\":\"http://localhost:4000\",\"logo\":\"http://localhost:4000/logo.png\"}"}],"noscript":[],"title":"Contract Manager","titleTemplate":"%s | Contract Manager","htmlAttrs":{"lang":"es"}};
