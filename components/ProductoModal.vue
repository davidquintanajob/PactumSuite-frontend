...
const handleSubmit = async () => {
  errorMsg.value = '';
  if (!formData.value.codigo || !formData.value.nombre || !formData.value.precio || !formData.value.unidadMedida) {
    errorMsg.value = 'Los campos Código, Nombre, Precio y Unidad de Medida son obligatorios.';
    return;
  }
